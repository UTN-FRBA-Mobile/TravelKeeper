...
import utn.kotlin.travelkeeper.domain.*
import utn.kotlin.travelkeeper.features.destinations.EditDestinationActivity
import utn.kotlin.travelkeeper.features.destinations.NewDestinationActivity
import utn.kotlin.travelkeeper.features.flights.EditFlightActivity
import utn.kotlin.travelkeeper.features.flights.NewFlightActivity
    ...
    private fun deleteDestinationFromFirebase(destination: Destination, position: Int) {
        viajesService.deleteDestinationInTrip(
            ...
            object : UsuariosService.SimpleServiceListener {
                override fun onSuccess() {
                    Toast.makeText(
                        this@TripTimeLineActivity,
                        R.string.destination_removed, Toast.LENGTH_SHORT
                    )
                        .show()
                    tripElements.removeAt(position)
                    resetAdapter()
                ...
                override fun onError(exception: Exception) {
                    Toast.makeText(
                        this@TripTimeLineActivity,
                        R.string.destination_not_removed, Toast.LENGTH_SHORT
                    )
                        .show()
                }
            }
